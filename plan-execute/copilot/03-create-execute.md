...
Generate a Github Copilot prompt named `execute` (`.github/prompts/execute.prompt.md`) that directs AI Agent into implementation of provided action plan.
Action plans are created with `.github/prompts/plan.prompt.md` command and optionally updated with `.github/prompts/plan-update.prompt.md` command.
