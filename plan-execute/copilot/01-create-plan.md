...
Generate a Copilot prompt file named `plan` (`.github/prompts/plan.prompt.md`) that directs AI Agent into providing a comprehensive development plan. The command must ensure that:
...
6. It is preffered, that steps (or phases consisting of multiple steps) contain deliverable increments that can be safely merged into the main branch and released without harming software quality and stability.
